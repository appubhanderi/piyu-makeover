    ...
    return (
        <Container className=''>
            ...
            <Row className='' style={{ overflow: 'hidden' }}>
                <Col md={6} className='p-md-4 mb-2' data-aos="flip-left" data-aos-duration="2000" >
                ...
                <Col md={6} className='pt-4 mb-3 homepages' data-aos="flip-right" data-aos-duration="2000">
                    <div className='p-2'
                        style={{
                            boxShadow: '0 10px 20px rgba(0, 0, 0, 0.19), 0 6px 6px rgba(0, 0, 0, 0.23)',
                        ...
                        <h1 className='display-3 fw-bold pb-3' style={{ color: '#ff69b4' }}>WELCOME</h1>
                        <h3 className='pb-3' style={{ color: '#ff69b4' }}>TO THE BEST <br /> HAIRDRESSING SALON<br /> IN GUJRAT SURAT!</h3>
                        <p style={{ lineHeight: 2, }} className='text-center'>This salon, founded by three best friends Mary, Brenda and Alberta is now the Gujrat Surat’s
